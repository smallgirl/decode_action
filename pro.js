...
dt[Z(345)][Z(340)][Z(372)](e => {
  ...
  // var o = (new Date().getTime() + 0).toString(),
...
(function (e, t) {
  ...
  const c = Date,
    ...
    u = function (p) {
      ...
      alert('u---');
      alert(p);
      //alert(g(393)); //toString
     // alert(_); 
      //alert(g(391)); //slice
     // alert(v); //0-12
     // alert(g(r._0x2852bf)); //length
     // alert(g(396)); //length
  ...
  Date.now = function () {
    ...
    const p = s,
      ...
      //alert(p(n._0x5b34bf));//call

      alert('end');//time
      alert(v);//time
      alert(_);// time /10
      alert(_ * 10 + v);// time /10
     // alert(p(n._0x35642b));//floor
     // alert(_);// time /10
     // alert(p(n._0x35642b));//floor
