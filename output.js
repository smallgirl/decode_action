//Thu Feb 27 2025 09:23:30 GMT+0000 (Coordinated Universal Time)
//Base:https://github.com/echo094/decode-js
//Modify:https://github.com/smallfawn/decode_action
var MIZHI = {
  "start": function () {
    window.MIZHI.version = "MizhiPlayer觅知弹幕ART播放器";
    window.MIZHI.versionnum = "V24.12.1";
    window.MIZHI.versionkey = "Mizhi_ART_Player";
    $.ajax({
      "url": "/admin/api.php",
      "dataType": "json",
      "success": function (_0x3ae7b5) {
        MIZHI.waittime = _0x3ae7b5.data.waittime;
        MIZHI.adss = _0x3ae7b5.data.ads;
        config.logo = _0x3ae7b5.data.logo;
        up.pbgjz = _0x3ae7b5.data.pbgjz;
        up.trysee = _0x3ae7b5.data.trytime;
        config.sendtime = _0x3ae7b5.data.sendtime;
        config.color = _0x3ae7b5.data.color;
        config.pmdoff = _0x3ae7b5.data.pmdoff;
        config.pmdzdy = _0x3ae7b5.data.pmdzdy;
        config.pmdloopnum = _0x3ae7b5.data.pmdloopnum;
        config.pmdspeed = _0x3ae7b5.data.pmdspeed;
        config.pmdtopweizhi = _0x3ae7b5.data.pmdtopweizhi;
        up.dmrule = _0x3ae7b5.data.dmrule;
        danmuon = _0x3ae7b5.data.danmuon;
        MIZHI.err_bg = _0x3ae7b5.data.err_bg;
        MIZHI.err_bg_imgurl = _0x3ae7b5.data.err_bg_imgurl;
        MIZHI.err_bg_vodurl = _0x3ae7b5.data.err_bg_vodurl;
        MIZHI.video_thumbnails = _0x3ae7b5.data.video_thumbnails;
        MIZHI.errzdytext = _0x3ae7b5.data.errzdytext;
        MIZHI.errzdylink = _0x3ae7b5.data.errzdylink;
        MIZHI.errzdylink = _0x3ae7b5.data.errzdylink;
        MIZHI.keywords = _0x3ae7b5.data.keywords;
        MIZHI.contenttext = _0x3ae7b5.data.content;
        MIZHI.xuanji = _0x3ae7b5.data.cmsapi;
        MIZHI.yiyanhitokoto_on = _0x3ae7b5.data.yiyanhitokoto;
        config.api_zyurl_domain_all = _0x3ae7b5.data.api_zyurl_domain_all;
        config.dm_url_canshu = _0x3ae7b5.data.dm_url_canshu;
        config.dm_list_on = _0x3ae7b5.data.dm_list_on;
        config.dm_speed = _0x3ae7b5.data.dm_speed;
        config.dm_fontSize = _0x3ae7b5.data.dm_fontSize;
        config.dm_margin_1 = _0x3ae7b5.data.dm_margin_1;
        config.dm_margin_2 = _0x3ae7b5.data.dm_margin_2;
      }
    });
    const _0x20755f = "MizhiPlayer觅知弹幕ART播放器",
      _0x51b47c = window.MIZHI ? window.MIZHI.version : "";
    _0x51b47c !== _0x20755f ? $(function () {
      $("#mizhi_zdyload").html("<div class=\"tips\">您当前使用的是盗版请购买正版官网:www.98dou.cn联系官方QQ2319281411</div></div>");
    }) : $(function () {
      var _0x576768 = "<div class=\"load_text\"><div class=\"load_img\">视频加载中,已等候<span>..</span><span id=\"timeCounter\"> 0 </span>秒</div><hr/><hr/><hr/><hr/></div>";
      $("#mizhi_zdyload").append(_0x576768);
      var _0x109aa5 = 0;
      function _0x1d41da() {
        _0x109aa5++;
        $("#timeCounter").text(_0x109aa5);
      }
      setInterval(_0x1d41da, 1000);
    });
  },
  "tips": function () {
    var _0x332632 = "<div class=\"main\"><div class=\"logo\"><img src=\"" + config.logo + "\"></div><div class=\"loading\"></div><div class=\"tips\">如果你觉得 " + up.mylink + " 不错~</br>记得把 " + up.title + " 推荐给朋友们</div></div>";
    $("#loading").append(_0x332632);
  },
  "modify": function () {
    ...
    function _0x48ea09() {
      ...
      clearTimeout(_0x437edc);
      if (bottom.is(":hover") == true) {
        bottom.css({
          "opacity": "1",
          "visibility": "visible"
        });
    ...
    if (MIZHI.video_thumbnails == "on") {
      video_thumbnails = "<div id=\"video_thumbnails\" class=\"art-control art-control-thumbnails\" data-index=\"20\" style=\"display: none;width: 160px;height: 90px;\"></div>";
      $(".art-control-progress").after(video_thumbnails);
      MIZHI.thumbnails_player("#video_thumbnails", MIZHI.player_url);
      MIZHI.art.on("mousemove", () => {
        ...
        } else $("#video_thumbnails").css("display", "none");
      });
    }
  ...
  "bili_pbp": function (_0x33235c, _0x4e261d, _0x3dcc6c) {
    if ($("#bilibili_pbp").length > 0) {
      Number(_0x33235c.replace("%", "")) > Number(_0x4e261d.replace("%", "")) && (window.x = _0x4e261d);
      ww = (Number(_0x4e261d.replace("%", "")) - Number(_0x33235c.replace("%", ""))).toFixed(2) + "%";
      _0x3dcc6c = _0x3dcc6c * 0.8;
      Number(ww.replace("%", "")) < 0 && (ww = "0%");
      ...
      function _0x488d54() {
        var _0x3886f3 = new Array(path0, path1, path2, path3, path4),
          _0x3b13c0 = Math.floor(Math.random() * _0x3886f3.length);
        return _0x3886f3[_0x3b13c0];
      }
      svg = "<svg viewBox=\"0 0 1000 100\" preserveAspectRatio=\"none\" width=\"100%\" height=\"100%\"><defs><clipPath id=\"pbp-curve-path\" clipPathUnits=\"userSpaceOnUse\">" + _0x488d54() + "</clipPath><clipPath id=\"pbp-played-path\" clipPathUnits=\"userSpaceOnUse\"><rect x=\"" + _0x33235c + "\" width=\"" + _0x4e261d + "\" y=\"0\" height=\"100%\"></rect><path d=\"\"></path></clipPath></defs><g fill-opacity=\"0.2\" clip-path=\"url(#pbp-curve-path)\" class=\"bilibili-player-videoshot-area\"><rect x=\"0\" y=\"0\" width=\"100%\" height=\"100%\" fill=\"rgb(255,255,255)\"></rect><rect x=\"0\" y=\"0\" width=\"100%\" height=\"100%\" fill=\"rgb(35,173,229)\" clip-path=\"url(#pbp-played-path)\"></rect></g></svg>";
      pbp_html = "<div id=\"bilibili_pbp\">" + svg + "</div>";
      $(".art-control-progress-inner").prepend(pbp_html);
    }
  },
  "thumbnails_player": function (_0x5eaf7b, _0x5981f7) {
    ths = new Artplayer({
      "container": _0x5eaf7b,
      "url": _0x5981f7,
      "muted": true,
      ...
      "customType": {
        "m3u8": function (_0x1a9184, _0x2bc6b7) {
          if (Hls.isSupported()) {
            const _0x4882fb = new Hls();
            _0x4882fb.loadSource(_0x2bc6b7);
            _0x4882fb.attachMedia(_0x1a9184);
          } else {
            const _0x232d89 = _0x1a9184.canPlayType("application/vnd.apple.mpegurl");
            (_0x232d89 === "probably" || _0x232d89 == "maybe") && (_0x1a9184.src = _0x2bc6b7);
          }
        },
        "flv": function (_0x243aee, _0x4b1d73) {
          if (flvjs.isSupported()) {
            const _0x1e243a = flvjs.createPlayer({
              "type": "flv",
              "url": _0x4b1d73
            });
            _0x1e243a.attachMediaElement(_0x243aee);
            _0x1e243a.load();
          }
        },
        "mpd": function (_0x508ffe, _0x493a73) {
          shaka.polyfill.installAll();
          var _0x4bc700 = new shaka.Player(_0x508ffe);
          _0x4bc700.load(_0x493a73);
        },
        "torrent": function (_0x206c5c, _0xa57c8a, _0x3ad88f) {
          var _0x5c6c5b = new WebTorrent();
          _0x3ad88f.loading.show = true;
          _0x5c6c5b.add(_0xa57c8a, function (_0x25552a) {
            var _0x169338 = _0x25552a.files[0];
            _0x169338.renderTo(_0x206c5c, {
              "autoplay": true
            });
          });
        }
  ...
  "player": function (_0x5194ee, _0x58f962) {
    MIZHI.tips();
    MIZHI.start();
    Artplayer.INDICATOR_SIZE_ICON = 24;
    if (typeof _0x5194ee.api_zyurl_domain_all === "string" && _0x5194ee.api_zyurl_domain_all.trim() !== "") {
      var _0x5214f7 = _0x5194ee.api_zyurl_domain_all,
        _0x4b9bc6 = _0x5214f7.split("|"),
        _0x1d981c = false;
      for (var _0x27d137 = 0; _0x27d137 < _0x4b9bc6.length; _0x27d137++) {
        if (_0x5194ee.url.indexOf(_0x4b9bc6[_0x27d137]) !== -1 && _0x5194ee.url.indexOf(".m3u8") !== -1) {
          _0x1d981c = true;
          break;
        }
      }
      _0x1d981c ? ($.ajaxSettings.timeout = 30000, $.post("/admin/mizhi_json.php", {
        "url": _0x5194ee.url,
        "time": _0x5194ee.time,
        "key": _0x5194ee.key,
        "vkey": _0x5194ee.vkey
      }, function (_0x17837f) {
        !!_0x17837f.metareferer && $("head").append("<meta name=\"referrer\" content=\"" + _0x17837f.metareferer + "\">");
        if (_0x17837f.code == 200) MIZHI.MZPlayer(_0x17837f.url, _0x5194ee.title, _0x5194ee.vkey, _0x5194ee.next, _0x5194ee.img, _0x5194ee.live, _0x17837f.xl);else {
          MIZHI.TheError();
        }
      }, "json").error(function (_0x3f16b4, _0x1f5b3b, _0x5c274d) {
        MIZHI.TheError();
      })) : _0x5194ee.url.indexOf(".m3u8") !== -1 || _0x5194ee.url.indexOf(".mp4") !== -1 || _0x5194ee.url.indexOf(".flv") !== -1 || _0x5194ee.url.indexOf(".mkv") !== -1 || _0x5194ee.url.indexOf("ixigua") !== -1 || _0x5194ee.live === true ? MIZHI.MZPlayer(_0x5194ee.url, _0x5194ee.title, _0x5194ee.vkey, _0x5194ee.next, _0x5194ee.img, _0x5194ee.live, "H5播放器") : ($.ajaxSettings.timeout = 30000, $.post("/admin/mizhi_json.php", {
        "url": _0x5194ee.url,
        "time": _0x5194ee.time,
        "key": _0x5194ee.key,
        "vkey": _0x5194ee.vkey
      }, function (_0x167624) {
        !!_0x167624.metareferer && $("head").append("<meta name=\"referrer\" content=\"" + _0x167624.metareferer + "\">");
        _0x167624.code == 200 ? MIZHI.MZPlayer(_0x167624.url, _0x5194ee.title, _0x5194ee.vkey, _0x5194ee.next, _0x5194ee.img, _0x5194ee.live, _0x167624.xl) : MIZHI.TheError();
      }, "json").error(function (_0x3d5207, _0xf305ab, _0x575ab9) {
        MIZHI.TheError();
      }));
    } else _0x5194ee.url.indexOf(".m3u8") !== -1 || _0x5194ee.url.indexOf(".mp4") !== -1 || _0x5194ee.url.indexOf(".flv") !== -1 || _0x5194ee.url.indexOf(".mkv") !== -1 || _0x5194ee.url.indexOf("ixigua") !== -1 || _0x5194ee.live === true ? MIZHI.MZPlayer(_0x5194ee.url, _0x5194ee.title, _0x5194ee.vkey, _0x5194ee.next, _0x5194ee.img, _0x5194ee.live, "H5播放器") : ($.ajaxSettings.timeout = 30000, $.post("/admin/mizhi_json.php", {
      "url": _0x5194ee.url,
      "time": _0x5194ee.time,
      "key": _0x5194ee.key,
      "vkey": _0x5194ee.vkey
    }, function (_0xf6b139) {
      !!_0xf6b139.metareferer && $("head").append("<meta name=\"referrer\" content=\"" + _0xf6b139.metareferer + "\">");
      _0xf6b139.code == 200 ? MIZHI.MZPlayer(_0xf6b139.url, _0x5194ee.title, _0x5194ee.vkey, _0x5194ee.next, _0x5194ee.img, _0x5194ee.live, _0xf6b139.xl) : MIZHI.TheError();
    }, "json").error(function (_0x59e083, _0x86bab, _0x4d55f7) {
      MIZHI.TheError();
    }));
  },
  "video": {
    "play": function () {
      if (MIZHI.cookie.get("MZPlayer-" + up.id) >= 3) {
        ...
        var _0x27399e = Number(MIZHI.waittime),
          _0xdeefc4;
        _0xdeefc4 = setInterval(() => {
          $("#mes").html(_0x27399e);
          _0x27399e == 0 && (MIZHI.art.seek = ckseek - 3, clearInterval(_0xdeefc4), $(".art-layer-autoPlayback").remove(), MIZHI.video.vlum());
          _0x27399e--;
        }, 1000);
        $(".art-icon-close").on("click", function () {
          clearInterval(_0xdeefc4);
          MIZHI.art.play();
      ...
      if (config.pmdoff === "on") {
        let _0x5d85b7 = $(".art-danmuku");
        _0x5d85b7.after("<div class=\"marquee\"><marquee loop=\"" + config.pmdloopnum + "\" width=\"100%\" scrollamount=\"" + config.pmdspeed + "\" class=\"font\">" + config.pmdzdy + "</marquee></div>");
    ...
    "next": function (_0x40597) {
      top.location.href = _0x40597;
    },
    "seek": function () {
      MIZHI.art.seek = MIZHI.playtime;
    },
    "end": function (_0x3f940c) {
    ...
    "list": function () {
      ...
      $(document).on("click", "#Mizhi-tab-select", function () {
        ...
        $(".Mizhi-list a").click(function () {
          ...
          let _0x19e8fa = $(".Mizhi-list a").index(this),
            _0x2857b9 = $(".scroll-area .Mizhi-selset-list").eq(_0x19e8fa);
          _0x2857b9.addClass("Mizhi-show").siblings().removeClass("Mizhi-show");
          $(".Mizhi-list").hide();
        });
      });
      if ($(".normal-title-wrap").length < 1) {
        let _0x49932b = $(".anthology-wrap");
        $.ajax({
          "url": "/admin/api.php?ac=list&key=888&url=" + config.url + "&ids=" + config.ids,
          "type": "get",
          "dataType": "json",
          "beforeSend": function () {
            let _0x5082f4 = "<div class=\"normal-title-wrap\"><div class=\"thesis-wrap\"><a class=\"title-link beforeSend h-2\"></a></div><div class=\"title-info beforeSend h-2\"></div></div><div class=\"scroll-area\"><a class=\"component-title beforeSend\"></a><div class=\"Mizhi-show Mizhi-selset-list anthology-content\"><a class=\"box-item album-title beforeSend\"></a><a class=\"box-item album-title beforeSend\"></a></div><a class=\"component-title beforeSend\"></a><div class=\"anthology-content\"><div class=\"pic-text-item\"><a><div class=\"cover beforeSend\"></div></a></div></div></div>";
            _0x49932b.html(_0x5082f4);
          },
          "success": function (_0x1431dc) {
            if (_0x1431dc.code == "200") {
              MIZHI.part = _0x1431dc.part;
              MIZHI.vod_pic = _0x1431dc.vod_pic;
              MIZHI.vod_actor = _0x1431dc.vod_actor;
              MIZHI.vod_year = _0x1431dc.vod_year;
              MIZHI.type_name = _0x1431dc.type_name;
              MIZHI.vod_area = _0x1431dc.vod_area;
              MIZHI.vod_content = _0x1431dc.vod_content;
              _0x49932b.html(_0x1431dc.html);
            } else _0x49932b.html("<div class=\"pop-msg\">查找内容失败...</div>");
          },
          "error": function () {
            _0x49932b.html("<div class=\"pop-msg\">请求失败...</div>");
          }
        });
      }
    },
    "list_top": function () {
      var _0x10928c = document.querySelector(".Mizhi-show > a.active");
      if (!_0x10928c) {
        console.warn("未找到活动链接");
        return;
      }
      var _0x6c5c0e = _0x10928c.offsetTop,
        _0xe4038b = $(".scroll-area");
      _0xe4038b.length > 0 && (_0x6c5c0e < 0 && (_0x6c5c0e = 0), _0xe4038b.scrollTop(_0x6c5c0e));
    }
  },
  "pause": {
    "bg_html": function (_0x5805cc) {
      (_0x5805cc == "" || _0x5805cc == undefined) && (MIZHI.title != null && MIZHI.title != undefined && MIZHI.title != "" ? _0x5805cc = MIZHI.title + " <span class=\"screen-saver-h3\">" + MIZHI.part + "</span>" : _0x5805cc = MIZHI.web_title + MIZHI.web_title_url);
      let _0x2a84a5 = MIZHI.contenttext,
        _0x371bdd = "全网影迷聚集地，看视频就用&nbsp;-&nbsp;" + _0x5805cc;
      MIZHI.vod_content != undefined && (_0x2a84a5 = MIZHI.vod_content.replace(/<.*?>/g, ""), _0x371bdd = "<p class=\"screen-saver-h4\">" + MIZHI.vod_year + " " + MIZHI.type_name + " " + MIZHI.vod_area + "</p>主演：" + MIZHI.vod_actor);
      if (MIZHI.yiyanhitokoto_on === "on") fetch("./admin/yiyan/?type=json").then(_0x44bff0 => _0x44bff0.json()).then(_0x2972bc => {
        let _0x169e9f = _0x2972bc.full,
          _0x4209be = "<div id=\"pause-html\" style=\"display: none;\">";
        config.pic && (_0x4209be += "<img class=\"pic-play\" src=\"" + config.pic + "\">");
        _0x4209be += "<div class=\"large screen-saver-box\"><span class=\"screen-saver-h1\">正在观看——暂停中</span><h2 class=\"screen-saver-h2\">" + _0x5805cc + "</h2></br><h3 class=\"screen-saver-h1\">" + _0x371bdd + "</h3><p class=\"screen-saver-h5 hitokoto\">" + _0x2a84a5 + "</p></br><p class=\"screen-saver-h5 hitokoto\">今日一言：" + _0x169e9f + "</p><span class=\"screen-saver-h6\">暂停中</span></div></div>";
        $(".art-video-player:first").prepend(_0x4209be);
        $(document).mousemove(function () {
          $("#pause-html").css({
            "display": "none"
          });
        });
      }).catch(_0x10425c => console.error("Error fetching the quote:", _0x10425c));else {
        let _0x56fb40 = "<div id=\"pause-html\" style=\"display: none;\">";
        config.pic && (_0x56fb40 += "<img class=\"pic-play\" src=\"" + config.pic + "\">");
        _0x56fb40 += "<div class=\"large screen-saver-box\"><span class=\"screen-saver-h1\">正在观看——暂停中</span><h2 class=\"screen-saver-h2\">" + _0x5805cc + "</h2></br><h3 class=\"screen-saver-h1\">" + _0x371bdd + "</h3><p class=\"screen-saver-h5 hitokoto\">" + _0x2a84a5 + "</p><span class=\"screen-saver-h6\">暂停中</span></div></div>";
        $(".art-video-player:first").prepend(_0x56fb40);
      }
    }
  },
  "ads": {
    ...
    "adoff": function (_0x84b04) {
      $(_0x84b04).remove();
    },
    "adplay": function (_0x3374f4) {
  ...
  "TheError": function () {
    ...
    if (MIZHI.err_bg == "video") {
      ...
      var _0x4b1bd1 = document.getElementById("video");
      _0x4b1bd1.muted == true ? ($("#sound-icon").text("关闭声音"), _0x4b1bd1.muted = false) : ($("#sound-icon").text("打开声音"), _0x4b1bd1.muted = true);
    } else $("body").append(err_html);
  },
  "cookie": {
    "set": function (_0x5e9dbd, _0x7c96c1, _0xbb9e06) {
      var _0x3a1b5b = new Date();
      _0x3a1b5b.setTime(_0x3a1b5b.getTime() + _0xbb9e06 * 24 * 60 * 60 * 1000);
      document.cookie = _0x5e9dbd + "=" + escape(_0x7c96c1) + ";path=/;expires=" + _0x3a1b5b.toUTCString();
    },
    "get": function (_0x4ad20b) {
      var _0x400dc1 = document.cookie.match(new RegExp("(^| )" + _0x4ad20b + "=([^;]*)(;|$)"));
      if (_0x400dc1 != null) {
        return unescape(_0x400dc1[2]);
      }
    }
  },
  "formatTime": function (_0x1beb45) {
    return [parseInt(_0x1beb45 / 60 / 60), parseInt(_0x1beb45 / 60 % 60), parseInt(_0x1beb45 % 60)].join(":").replace(/\b(\d)\b/g, "0$1");
  },
  "formatTimes": function (_0xe9659e) {
    var _0x371f1d = _0xe9659e.slice(-8, -6) * 3600,
      _0x233f51 = _0xe9659e.slice(-5, -3) * 60,
      _0x18a88d = _0xe9659e.slice(-2);
    return Number(_0x371f1d) + Number(_0x233f51) + Number(_0x18a88d);
  },
  "danmu": {
    "api": function (_0x548a36, _0x18ef95, _0x350d19, _0x32795a = true, _0x5a4c1a) {
      var _0xf647b9 = $("#dm-text-input");
      _0x5a4c1a = $("#dm-send-btn");
      _0xf647b9.on("click", function () {
        _0x548a36 = _0xf647b9.value;
    ...
    "send": function () {
      var _0x4fd0d2 = $(".art-danmuku-send"),
        _0x100f2e = $(".art-danmuku-input"),
        _0x1458b3 = ".MizhiPlayer-comment-setting-";
      $(_0x1458b3 + "color input").on("click", function () {
        var _0x407e54 = $(this).attr("value");
        setTimeout(function () {
          _0x100f2e.css({
            "color": _0x407e54
          });
      ...
      $(_0x1458b3 + "type input").on("click", function () {
        var _0x5110bc = $(this).attr("value");
        setTimeout(function () {
          _0x100f2e.attr("dmtype", _0x5110bc);
        }, 100);
      });
      $(_0x1458b3 + "font input").on("click", function () {
        if (up.trysee > 0 && config.group == config.group_x) {
          layer.msg("会员专属功能");
          return;
        }
        var _0x8df0ed = $(this).attr("value");
        setTimeout(function () {
          _0x100f2e.attr("size", _0x8df0ed);
        }, 100);
      });
      _0x4fd0d2.on("click", function () {
        var _0x534744 = MIZHI.dmemit.text != "" ? MIZHI.dmemit.text : document.getElementsByClassName("art-danmuku-input").value,
          _0x5e4f11 = _0x100f2e.css("color"),
          _0xaf4398 = _0x100f2e.attr("size");
        if (up.trysee > 0 && config.group < config.group_x && config.group != "") {
          layer.msg("登陆后才能发弹幕yo(・ω・)");
          return;
        }
        if (_0x534744 == undefined || _0x534744 == "") {
          layer.msg("要输入弹幕内容啊喂！");
          return;
        }
        for (var _0x32ffe1 = 0; _0x32ffe1 < up.pbgjz.length; _0x32ffe1++) {
          if (_0x534744.search(up.pbgjz[_0x32ffe1]) != -1) {
            layer.msg("请勿发送无意义内容，规范您的弹幕内容");
            return;
          }
        }
        var _0x483e10 = Date.parse(new Date()),
          _0x34fb94 = MIZHI.Mizhick.get("dmsent", _0x483e10);
        if (_0x483e10 - _0x34fb94 < config.sendtime * 1000) {
          layer.msg("请勿频繁操作！发送弹幕需间隔" + config.sendtime + "秒~");
          return;
        }
        _0x100f2e.val("");
        MIZHI.Mizhick.set("dmsent", _0x483e10);
        MIZHI.danmu.post_add(MIZHI.dmemit.time, _0x534744, _0x5e4f11, MIZHI.dmemit.mode, MIZHI.dmemit.border, _0xaf4398);
      });
      function _0x31d308() {
        _0x4fd0d2.trigger("click");
      }
      _0x100f2e.keydown(function (_0x1625e8) {
        _0x1625e8.keyCode == 13 && _0x31d308();
      });
    },
    "liyi": function () {
      var _0x362a0e = "<div class=\"dmrules\"><a target=\"_blank\" href=\"" + up.dmrule + "\">弹幕礼仪 </a></div>";
      $("div.art-danmuku-left:first").append(_0x362a0e);
    },
    "loading": function () {
      MIZHI.danmu.send();
      var _0x126ff5 = up.danmuku + config.dm_url_canshu + up.id,
        _0x3ca261 = [{
      ...
      $.getJSON(_0x126ff5, function (_0x1e82c5) {
        $("#danmuku-id").text(up.id);
        $("#danmuku-num").text(_0x1e82c5.danum);
        MIZHI.dmdata = eval(_0x3ca261);
        $.each(_0x1e82c5.danmuku, function (_0x13a6df, _0x4190ca) {
          var _0xf2968a = {
            "text": _0x4190ca[4],
            "time": _0x4190ca[0],
            "color": _0x4190ca[2],
        ...
        MIZHI.art.plugins.artplayerPluginDanmuku.config({
          ...
          "filter": function (_0x55ce18) {
            return _0x55ce18.text.length < 50;
          },
          ...
          "maxWidth": 500,
          "theme": "dark",
          "beforeEmit": function (_0x4433f6) {
            return !!_0x4433f6.text.trim();
          }
        });
    ...
    "list": function () {
      ...
      $.ajax({
        ...
        "success": function (_0xdfed8d) {
          if (_0xdfed8d.code == 23) {
            var _0x5311c4 = _0xdfed8d.danmuku,
              _0x1a8477 = _0xdfed8d.name,
              _0x2e2228 = _0xdfed8d.danum;
            $("#danmuku-id").text(up.id);
            $("#danmuku-num, .danmuku-num").text(_0x2e2228);
            $(_0x5311c4).each(function (_0x3c1a9c, _0x334790) {
              var _0x3bf130 = "<d class=\"danmuku-list\" time=\"" + _0x334790[0] + "\"><li>" + MIZHI.formatTime(_0x334790[0]) + "</li><li title=\"" + _0x334790[4] + "\">" + _0x334790[4] + "</li><li title=\"用户：" + _0x334790[3] + "  IP地址：" + _0x334790[5] + "\">" + _0x334790[6] + "</li><li class=\"report\" onclick=\"MIZHI.danmu.report('" + _0x334790[5] + "','" + _0x1a8477 + "','" + _0x334790[4] + "','" + _0x334790[3] + "')\">举报</li></d>";
              $(".list-show").append(_0x3bf130);
            });
          }
      ...
      for (var _0x41b9ca = 0; _0x41b9ca < up.pbgjz.length; _0x41b9ca++) {
        var _0x55adaf = "<e>" + up.pbgjz[_0x41b9ca] + "</e>";
        $("#vod-title").append(_0x55adaf);
      }
      _0x13670d(".MizhiPlayer-list-icon", ".MizhiPlayer-danmu", "show");
      function _0x13670d(_0x25f15c, _0x2ed8e4, _0x537064, _0x45a993) {
        $(_0x25f15c).click(function () {
          $(_0x2ed8e4).toggleClass(_0x537064);
          _0x45a993 && $(_0x45a993).remove();
        });
      }
    },
    "report": function (_0x399aca, _0x2ceaaa, _0x27b879, _0x442741) {
      layer.confirm("" + _0x27b879 + "<!--br><br><span style=\"color:#333\">请选择需要举报的类型</span-->", {
        "anim": 1,
        "area": ["300px", "230px"],
        "shade": 0,
        "title": "举报弹幕",
        "btn": ["违法违禁", "色情低俗", "恶意刷屏", "赌博诈骗", "人身攻击", "侵犯隐私", "垃圾广告", "剧透", "引战"],
        "btn3": function (_0x86397b, _0x4153ed) {
          MIZHI.danmu.post_r(_0x399aca, _0x2ceaaa, _0x27b879, _0x442741, "恶意刷屏");
        },
        "btn4": function (_0x2414be, _0x205e8a) {
          MIZHI.danmu.post_r(_0x399aca, _0x2ceaaa, _0x27b879, _0x442741, "赌博诈骗");
        },
        "btn5": function (_0x5efa0b, _0x49a2b1) {
          MIZHI.danmu.post_r(_0x399aca, _0x2ceaaa, _0x27b879, _0x442741, "人身攻击");
        },
        "btn6": function (_0x5adc49, _0xa27aee) {
          MIZHI.danmu.post_r(_0x399aca, _0x2ceaaa, _0x27b879, _0x442741, "侵犯隐私");
        },
        "btn7": function (_0x4f7837, _0x392d1b) {
          MIZHI.danmu.post_r(_0x399aca, _0x2ceaaa, _0x27b879, _0x442741, "垃圾广告");
        },
        "btn8": function (_0x3f52d5, _0x47ea0e) {
          MIZHI.danmu.post_r(_0x399aca, _0x2ceaaa, _0x27b879, _0x442741, "剧透");
        },
        "btn9": function (_0x1be677, _0x298efc) {
          MIZHI.danmu.post_r(_0x399aca, _0x2ceaaa, _0x27b879, _0x442741, "引战");
        }
      }, function (_0x375cd0, _0x109a3b) {
        MIZHI.danmu.post_r(_0x399aca, _0x2ceaaa, _0x27b879, _0x442741, "违法违禁");
      }, function (_0x21f014) {
        MIZHI.danmu.post_r(_0x399aca, _0x2ceaaa, _0x27b879, _0x442741, "色情低俗");
      });
    },
    "post_r": function (_0x2fbf1d, _0x428690, _0x55235c, _0x5d82b1, _0x419d8e) {
      $.ajax({
        "type": "get",
        "url": up.danmuku + "?ac=report&cid=" + _0x5d82b1 + "&user=" + _0x2fbf1d + "&type=" + _0x419d8e + "&title=" + _0x428690 + "&text=" + _0x55235c,
        "cache": false,
        "dataType": "json",
        "beforeSend": function () {},
        "success": function (_0x4011c2) {
          layer.msg("举报成功！感谢您为守护弹幕作出了贡献");
        },
        "error": function (_0x44342e) {
          var _0x728216 = "服务故障 or 网络异常，稍后再试！";
          layer.msg(_0x728216);
        }
      });
    },
    "post_add": function (_0x1e9e83, _0x3edb38, _0x5b50a5, _0x8d9d61, _0x4390d7) {
      _0x8d9d61 == "0" ? type = "right" : type = "top";
      var _0x4a88e6 = {
        "player": up.id,
        "time": _0x1e9e83,
        "text": _0x3edb38,
      ...
      $.ajax({
        ...
        "data": JSON.stringify(_0x4a88e6),
        "method": "post",
        "dataType": "json",
        "contentType": "application/json",
        "success": function (_0x12dea0) {
          if (_0x12dea0.code == 23) {
            window.token = _0x12dea0.danmuku;
            layer.tips("发送成功", ".art-danmuku-send", {
              "tips": [1, "#ff0000d5"]
            });
          } else layer.msg("发送失败:" + _0x12dea0, {
            "offset": "b"
          });
        }
      });
  ...
  "dlcls": function (_0x54b3c6, _0x1f00be) {
    $(_0x54b3c6).removeClass(_0x1f00be);
  },
  "kuaijie": function () {
    var _0x5a5431 = "<div id=\"kuaijie\" class=\"layui-layer-content\"><div style=\"margin:auto 25px auto 25px\"><div style=\"float:left\">Space(空格)</div><div style=\"float:right;color:#999\">播放/暂停</div><br><div style=\"float:left\">→</div><div style=\"float:right;color:#999\">快进5秒</div><br><div style=\"float:left\">←</div><div style=\"float:right;color:#999\">快退5秒</div><br><div style=\"float:left\">↑</div><div style=\"float:right;color:#999\">音量增加10%</div><br><div style=\"float:left\">↓</div><div style=\"float:right;color:#999\">音量降低10%</div><br><div style=\"float:left\">Esc</div><div style=\"float:right;color:#999\">退出全屏</div><br><div style=\"float:left\">F</div><div style=\"float:right;color:#999\">全屏/退出全屏</div><br><div style=\"float:left\">[</div><div style=\"float:right;color:#999\">上一集（已播放过）</div><br><div style=\"float:left\">]</div><div style=\"float:right;color:#999\">下一集</div><br><div style=\"float:left\">Enter</div><div style=\"float:right;color:#999\">发弹幕</div><br><div style=\"float:left\">右滑</div><div style=\"float:right;color:#999\">快进（手机）</div><br><div style=\"float:left\">左滑</div><div style=\"float:right;color:#999\">快退（手机）</div><br><div style=\"float:left\">上滑</div><div style=\"float:right;color:#999\">取消（快进快退中）</div></div></div>";
    layer.open({
      "id": "kuaijie",
      "zIndex": 200,
      "shade": 0,
      "title": "快捷键说明",
      "content": _0x5a5431,
      "success": function (_0x4b9999) {
        $(".art-video-player:first").append(_0x4b9999);
      }
    });
  },
  "tiaose": function () {
    var _0x3a37a7 = "<div id=\"tiaose\" class=\"layui-layer-content\"><div id=\"MizhiPlayer-tiao\"><div id=\"slidebhd-txt\" style=\"float:left\">饱和度：100</div><div id=\"slidebhd\" class=\"MizhiPlayer-slider\"></div><br><div id=\"slidemld-txt\" style=\"float:left\">明亮度：100</div><div id=\"slidemld\" class=\"MizhiPlayer-slider\"></div><br><div id=\"slidedbd-txt\" style=\"float:left\">对比度：100</div><div id=\"slidedbd\" class=\"MizhiPlayer-slider\"></div></div></div>";
    ...
    layui.use("slider", function () {
      var _0x3866db = layui.$,
        _0x480b1e = layui.slider;
      MIZHI.slidebhd = _0x480b1e.render({
        "elem": "#slidebhd",
        "min": 0,
        "max": 255,
        "value": MIZHI.saturate,
        "change": function (_0x246813) {
          _0x3866db("#slidebhd-txt").html("饱和度：" + _0x246813);
          MIZHI.saturate = _0x246813;
          _0x3866db("video").attr("style", "filter: saturate(" + MIZHI.saturate / 100 + ") brightness(" + MIZHI.brightness / 100 + ") contrast(" + MIZHI.contrast / 100 + ");");
        }
      });
      MIZHI.slidemld = _0x480b1e.render({
        "elem": "#slidemld",
        "min": 0,
        "max": 255,
        "value": MIZHI.brightness,
        "change": function (_0x256bda) {
          _0x3866db("#slidemld-txt").html("明亮度：" + _0x256bda);
          MIZHI.brightness = _0x256bda;
          _0x3866db("video").attr("style", "filter: saturate(" + MIZHI.saturate / 100 + ") brightness(" + MIZHI.brightness / 100 + ") contrast(" + MIZHI.contrast / 100 + ");");
        }
      });
      MIZHI.slidedbd = _0x480b1e.render({
        "elem": "#slidedbd",
        "min": 0,
        "max": 255,
        "value": MIZHI.contrast,
        "change": function (_0x31d363) {
          _0x3866db("#slidedbd-txt").html("对比度：" + _0x31d363);
          MIZHI.contrast = _0x31d363;
          _0x3866db("video").attr("style", "filter: saturate(" + MIZHI.saturate / 100 + ") brightness(" + MIZHI.brightness / 100 + ") contrast(" + MIZHI.contrast / 100 + ");");
        }
      });
    });
  },
  "showtime": function (_0x15a077) {
    if (config.show_time == "on") {
      var _0x140172 = document.getElementById(_0x15a077);
      setInterval(function () {
        var _0x4ee909 = new Date(),
          _0x2334ff = _0x55a0c3(_0x4ee909.getHours()) + ":" + _0x55a0c3(_0x4ee909.getMinutes()) + ":" + _0x55a0c3(_0x4ee909.getSeconds());
        _0x140172.innerHTML = _0x2334ff;
      }, 1000);
      function _0x55a0c3(_0x2ee749) {
        if (_0x2ee749 < 10) {
          return "0" + _0x2ee749;
        } else return _0x2ee749;
      }
    }
  },
  "hotkey": function (_0x3f39b2) {
    ...
    MIZHI.art.hotkey.add(221, () => {
      _0x3f39b2 ? top.location.href = _0x3f39b2 : MIZHI.art.notice.show = "没有下一集啦";
    });
    MIZHI.art.hotkey.add(13, () => {});
  },
  "MZPlayer": function (_0x47df06, _0x93e2fa, _0x4d6d41, _0x1912b4, _0x17320b, _0x54bf74, _0x3080ec) {
    window.MIZHI.player_url = _0x47df06;
    var _0x366497 = new Artplayer({
      "container": "#loading",
      "url": _0x47df06,
      "poster": _0x17320b,
      "title": _0x93e2fa,
      ...
      "settings": [{
        ...
        "onSelect": function (_0x3f8f4b, _0x4154f6, _0x53d958) {
          switch (_0x3f8f4b.html) {
            case "顺时针90°":
        ...
        "switch": false,
        "onSwitch": function (_0x2c0b64, _0x457fd3, _0x279f6e) {
          const _0x56a5c3 = !_0x2c0b64.switch;
          return _0x366497.pip = _0x56a5c3, _0x2c0b64.tooltip = _0x56a5c3 ? "开启" : "关闭", _0x56a5c3;
        }
      }, {
        "html": "循环播放",
        "tooltip": "关闭",
        "icon": MIZHI.svg.loop,
        "switch": false,
        "onSwitch": function (_0x3fc905, _0x52ae50, _0x2aeb3a) {
          const _0x4757cc = !_0x3fc905.switch;
          return _0x366497.option.loop = _0x4757cc, _0x366497.loop = _0x4757cc ? [0, _0x366497.duration] : [], _0x3fc905.tooltip = _0x4757cc ? "开启" : "关闭", _0x4757cc;
        }
      }],
      "layers": [{
        "name": "logo",
        ...
        "name": "videopic",
        "html": "<img class=\"pic-play\" src=\"" + up.adpic_pause + "\">",
        "style": {
          "display": "none"
        },
        "click": function () {}
      ...
      "customType": {
        "m3u8": function (_0xbc0057, _0x5e52c7) {
          if (Hls.isSupported()) {
            const _0x44b7ba = new Hls();
            _0x44b7ba.loadSource(_0x5e52c7);
            _0x44b7ba.attachMedia(_0xbc0057);
          } else {
            const _0x5995be = _0xbc0057.canPlayType("application/vnd.apple.mpegurl");
            _0x5995be === "probably" || _0x5995be == "maybe" ? _0xbc0057.src = _0x5e52c7 : _0x366497.notice.show = "不支持播放格式：m3u8";
          }
        },
        "flv": function (_0xc24284, _0x3ed6ca) {
          if (flvjs.isSupported()) {
            const _0xe12b96 = flvjs.createPlayer({
              "type": "flv",
              "url": _0x3ed6ca
            });
            _0xe12b96.attachMediaElement(_0xc24284);
            _0xe12b96.load();
          } else _0x366497.notice.show = "不支持播放格式：flv";
        },
        "mpd": function (_0xe734ee, _0x4b595b) {
          shaka.polyfill.installAll();
          var _0x518bc1 = new shaka.Player(_0xe734ee);
          _0x518bc1.load(_0x4b595b);
        },
        "torrent": function (_0x355b7f, _0x7e31c7, _0x13a022) {
          var _0x11015f = new WebTorrent();
          _0x13a022.loading.show = true;
          _0x11015f.add(_0x7e31c7, function (_0x46e070) {
            var _0x29729a = _0x46e070.files[0];
            _0x29729a.renderTo(_0x355b7f, {
              "autoplay": true
            });
          });
        }
      ...
      "contextmenu": [{
        ...
        "click": function (_0x36f59c) {
          window.open(config.right_link);
        }
      }]
    });
    window.MIZHI.art = _0x366497;
    window.MIZHI.JsonXl = _0x3080ec;
    !!config.contextmenu && _0x366497.contextmenu.add({
      "name": "contextmenu1",
      "html": config.contextmenu,
      "click": function (_0x49c699) {
        window.open(config.contextlink);
      }
    });
    _0x366497.contextmenu.add({
      "name": "tiaose",
      "html": "视频色彩调节",
      "index": 31,
      "click": function (_0x2a0aa9) {
        _0x366497.contextmenu.show = false;
        MIZHI.tiaose();
      }
    });
    _0x366497.contextmenu.add({
    ...
    _0x366497.on("ready", () => {
      MIZHI.video.list();
      MIZHI.video.play();
      _0x366497.playing == false && (_0x366497.layers.videopic.style.display = "block", MIZHI.pause.bg_html(_0x93e2fa));
      MIZHI.modify();
      MIZHI.hotkey(_0x1912b4);
      MIZHI.showtime("showtime");
      _0x366497.muted = false;
    ...
    _0x366497.on("video:playing", () => {
      layer.close(MIZHI.msgend);
      ($("#player_pause").length > 0 || $("#pause-html").length > 0) && (MIZHI.ads.adoff("#player_pause,#pause-html"), _0x366497.layers.videopic.style.display = "none");
    });
    var _0x10f57a = 0;
    _0x366497.on("video:timeupdate", () => {
      layer.close(MIZHI.msgend);
      MIZHI.cookie.set("MZPlayer-" + up.id, _0x366497.currentTime, 7);
      ending = _0x366497.duration - _0x366497.currentTime;
      if (ending < 6 && _0x10f57a == 0) {
        _0x10f57a = 1;
        if (_0x366497.option.loop) layer.msg("视频即将播放结束，5秒后将为你循环播放！", {
          "time": 5000,
          "anim": 2,
          "offset": ["88%", "10px"]
        });else _0x1912b4 && _0x47df06 && layer.msg("视频即将播放结束，5秒后将自动为您播放下一集！", {
          "time": 5000,
          "anim": 2,
          "offset": ["88%", "10px"]
        });
    ...
    _0x366497.on("video:volumechange", () => {
      MIZHI.cookie.set("MZPlayer-Volume", _0x366497.volume, 1);
      MIZHI.cookie.set("MZPlayer-Muted", _0x366497.muted, 1);
    });
    _0x366497.on("video:ended", () => {
      window.MIZHI.msgend;
      MIZHI.video.end();
      _0x1912b4 && !!_0x366497.loop ? (_0x366497.notice.show = "将自动为您播放下一集", _0x366497.title = _0x93e2fa + " 播放结束", top.location.href = _0x1912b4) : MIZHI.ads.pic_pause();
    });
    _0x366497.on("play", () => {
      _0x10f57a = 0;
      layer.close(MIZHI.msgend);
      MIZHI.ads.adoff("#player_pause,#pause-html");
      _0x366497.layers.videopic.style.display = "none";
      MIZHI.video.vlum();
    });
    _0x366497.on("pause", () => {
      _0x366497.layers.videopic.style.display = "block";
      MIZHI.ads.pic_pause();
      MIZHI.pause.bg_html(_0x93e2fa);
    });
    _0x366497.on("artplayerPluginDanmuku:emit", _0x22c70 => {
      window.MIZHI.dmemit = _0x22c70;
      MIZHI.danmu.send();
    });
    !!_0x1912b4 && _0x366497.controls.add({
      "name": "nextMedia",
      "position": "left",
      ...
      "index": 11,
      "oftenShow": true,
      "click": function (_0x49946c) {
        top.location.href = _0x1912b4;
      }
    });
    MIZHI.xuanji && MIZHI.xuanji.length > 0 && _0x366497.controls.add({
      "name": "apilist",
      "position": "left",
      ...
      "index": 40,
      "oftenShow": true,
      "click": function (_0x5c6683) {
        var _0x481e4c = $(".Mizhi-listbox");
        _0x481e4c.length > 0 ? ($(".vodlist-of, .r-button").toggle(), $(".Mizhi-stting").length > 0 ? _0x481e4c.removeClass("Mizhi-stting") : (_0x481e4c.addClass("Mizhi-stting"), MIZHI.video.list_top())) : (MIZHI.video.list(), _0x481e4c.addClass("Mizhi-stting"), MIZHI.video.list_top());
      }
    });
    !!up.danmuku && MIZHI.danmu.liyi() || config.dm_list_on === "on" && _0x366497.controls.add({
      "name": "dmlist",
      "position": "right",
      "html": MIZHI.svg.dmlist,
      "tooltip": "弹幕列表",
      "oftenShow": true,
      "click": function (_0x4e6983) {
        MIZHI.danmu.list();
        $("#danmu-show").hasClass("show") ? $("#danmu-show").removeClass("show") : $("#danmu-show").addClass("show");
      }
    });
    _0x366497.controls.add({
      "name": "tiaose",
      "position": "right",
      "html": MIZHI.svg.tiaose,
      "tooltip": "视频色彩调节",
      "oftenShow": true,
      "click": function (_0x5d2527) {
    ...
    console.log("%c%c此播放器唯一更新来源：觅知博客%cwww.98dou.cn", "line-height:28px;", "line-height:28px;padding:4px;background:#222;color:#FADFA3;font-size:14px;", "padding:4px;background:#FADFA3;color:#000;line-height:28px;font-size:14px;");
  ...
  "Mizhick": {
    "set": function (_0x5bdab1, _0x4b6087) {
      window.sessionStorage.setItem(_0x5bdab1, _0x4b6087);
    },
    "get": function (_0x47a1e8) {
      return window.sessionStorage.getItem(_0x47a1e8);
    },
    "del": function (_0x54d25b) {
      window.sessionStorage.removeItem(_0x54d25b);
    },
    "clear": function (_0x161aac) {
